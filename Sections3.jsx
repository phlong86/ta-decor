      ...
      <div style={{ position: 'relative', maxWidth: 'var(--container)', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '0.9fr 1.1fr', gap: 56, alignItems: 'center' }} className="tad-two">
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[{ i: 'phone', l: company.hotline, s: 'Hotline / Zalo' }, { i: 'mail', l: company.email, s: 'Email' }, { i: 'clock', l: company.hours, s: 'Giờ làm việc' }].map((r) => (
              <div key={r.s} style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                <span style={{ width: 46, height: 46, borderRadius: '50%', background: 'rgba(255,255,255,0.12)', border: '1px solid var(--border-on-dark)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><i data-lucide={r.i} style={{ width: 20, height: 20 }}></i></span>
                <div><div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17 }}>{r.l}</div><div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--text-on-dark-muted)' }}>{r.s}</div></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: '68px 24px 0', display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1fr', gap: 40 }} className="tad-foot">
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
            <img src="../../assets/logo-circle.jpg" alt="TA-Decor" style={{ width: 48, height: 48, borderRadius: '50%' }} />
        ...
        <div>
          ...
          <a href="#" style={{ ...linkStyle, display: 'flex', gap: 8, alignItems: 'center' }}><i data-lucide="map" style={{ width: 15, height: 15 }}></i>Xem trên Google Maps</a>
        </div>
      </div>
